...
$env.config = {
    show_banner: false # true # true or false to enable or disable the welcome banner at startup
...
$env.EDITOR = codium
# Theme path "%LOCALAPPDATA%\..\\Local\Programs\oh-my-posh\themes\cobalt2.omp.json"
source .oh-my-posh.nu

#alias ll = do { ls -l | sort-by type name -i}
#alias ls = do { ls | sort-by type name -i} # Always below other alias like `ll`
